...
def parse_args():
    ...
    parser.add_argument('--gpu', dest='gpu_id', help='GPU device id to use [0]',
            default=0, type=int)
    parser.add_argument('--data_dir', dest='data_dir', help='./datasets/AFLW2000',
          default='./datasets/AFLW2000', type=str)
    parser.add_argument('--filename_list', dest='filename_list', help='./datasets/AFLW2000/files.txt',
          default='./datasets/AFLW2000/files.txt', type=str)
    parser.add_argument('--snapshot', dest='snapshot', help='Name of model snapshot.',
          default='./output/snapshots/hopenet_robust_alpha1.pkl', type=str)
...
if __name__ == '__main__':
    ...
    for i, (images, labels, cont_labels, name) in enumerate(test_loader):
        ...
        if args.save_viz:
        # print("yaw_predicted[0]",yaw_predicted[0])
        # if False:
            name = name[0]
